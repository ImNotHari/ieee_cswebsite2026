  ...
  return (
    <div className="my-custom-face-container">
      <svg className="face" viewBox="0 0 320 380">
        <g fill="none" stroke="var(--color-text-primary)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="25">
          ...
          <rect className="face__nose" x="132.5" y="112.5" width="55" height="155" rx="4" ry="4" stroke="var(--accent-color)"></rect>
